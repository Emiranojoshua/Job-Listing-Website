<x-layout>
    ...
    <div class="lg:flex lg:items-center lg:justify-between m-10">
            ...
            <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                ...
                <div class="mt-2 flex items-center text-sm text-gray-500">
                    <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true" data-slot="icon">
                        <path fill-rule="evenodd"
                            d="M5.75 2a.75.75 0 0 1 .75.75V4h7V2.75a.75.75 0 0 1 1.5 0V4h.25A2.75 2.75 0 0 1 18 6.75v8.5A2.75 2.75 0 0 1 15.25 18H4.75A2.75 2.75 0 0 1 2 15.25v-8.5A2.75 2.75 0 0 1 4.75 4H5V2.75A.75.75 0 0 1 5.75 2Zm-1 5.5c-.6
                            9 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h10.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25H4.75Z"
                            clip-rule="evenodd" />
                    </svg>
                    {{ $job->due_date }}
                </div>
        ...
        @can('edit', $job)
            <div class="mt-5 flex lg:ml-4 lg:mt-0">
                <a href="{{ '/jobs/' . $job->id . '/edit' }}"><span class="sm:block">
                        <button type="button"
                ...
                <span class="sm:ml-3">
                    <x-form.form action="/jobs/{{ $job->id }}" _method="DELETE" method="POST">
                        <x-form.submit-button>Delete</x-form.submit-button>
                    </x-form.form>
                </span>
